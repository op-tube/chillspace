...
export const OPINIONS = ["love","like","enjoy","adore","appreciate","prefer","dig","stan","am into","am obsessed with","hate","dislike","detest","can't stand","despise","am not a fan of","am over","avoid","think [topic] is overrated","find [topic] boring","respect","support","believe in","am passionate about","am curious about","am learning","study","practice","live for","need more","want","crave","am tired of","am done with","vibe with","am chill with"];
export const TOPICS = ["coding","gaming","music","reading","art","cooking","sports","travel","photography","gardening","movies","anime","fitness","fashion","design","writing","dancing","nature","tech","science","history","psychology","finance","crypto","ai","robots","cars","space","food","coffee","memes","podcasts","youtube","tiktok","chess","puzzles"];

// Hardcoded fallback templates (in case DB is empty)
...
export function randChar() { return CHARS[randInt(36)]; }

export function fillTemplate(template, op1, t1, op2, t2) {
  return template
    .replace("[op1]", op1)
    .replace("[topic1]", t1)
    .replace("[op2]", op2)
